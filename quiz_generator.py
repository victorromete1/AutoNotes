...
class QuizGenerator:
    ...
    def _get_api_response(self, prompt: str) -> str:
        # Some models ignore response_format; we still pass it and also prompt strictly.
    ...
    def _parse_response_strict(self, response: str) -> Dict[str, Any]:
        ...
        # If it's a dict with Q1/Q2... keys, convert
    ...
    # --- mixed quiz generator (fixed shape) ---
    ...
    # --- field normalization (reused from your advanced code style) ---
    ...
    # --- (optional) simple grader helper used by AdvancedQuizSystem ---
